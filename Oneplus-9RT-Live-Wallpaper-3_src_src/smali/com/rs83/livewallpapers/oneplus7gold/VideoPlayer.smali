...
.method public declared-synchronized update()V
    ...
    iget-boolean v0, p0, Lcom/rs83/livewallpapers/oneplus7gold/VideoPlayer;->mNewFrameAvailable:Z
    ...
    .line 237
    # compute center-crop (fill) UV matrix and apply it
    ...
    # video wider than view -> scaleX < 1, scaleY = 1
    ...
    invoke-static {v18, v19}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    const/high16 v0, -0x41000000    # -0.5f

    invoke-static {v18, v19, v0, v0, v19}, Landroid/opengl/Matrix;->translateM([FIFFF)V

    invoke-static {v18, v19, v15, v17, v19}, Landroid/opengl/Matrix;->scaleM([FIFFF)V

    const/high16 v0, 0x3f000000    # 0.5f

    invoke-static {v18, v19, v0, v0, v19}, Landroid/opengl/Matrix;->translateM([FIFFF)V

    # multiply crop * oldUv -> result in temp array
    const/4 v0, 0x10
    ...
    invoke-static {v0, v19, v18, v19, v1, v19}, Landroid/opengl/Matrix;->multiplyMM([FI[FI[FI)V

    # set computed transform back
    iput-object v0, p0, Lcom/rs83/livewallpapers/oneplus7gold/VideoPlayer;->mUvTransform:[F
